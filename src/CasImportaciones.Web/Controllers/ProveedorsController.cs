...
namespace CasImportaciones.Web.Controllers
{
    public class ProveedorsController : Controller
    {
        ...
        public ProveedorsController(CasImportacionesDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdProveedor,NombreProveedor,Direccion,Telefono,Ciudad")] Proveedor proveedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdProveedor,NombreProveedor,Direccion,Telefono,Ciudad")] Proveedor proveedor)
        {
