...
namespace CasImportaciones.Web.Controllers
{
    public class InventarioController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdInventario,Referencia,Cantidad,Fecha")] Inventario inventario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdInventario,Referencia,Cantidad,Fecha")] Inventario inventario)
        {
